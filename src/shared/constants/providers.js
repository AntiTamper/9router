...
export const APIKEY_PROVIDERS = {
  ...
  kimi: { id: "kimi", alias: "kimi", name: "Kimi Code", icon: "psychology", color: "#1E3A8A", textIcon: "KM", website: "https://www.kimi.com/code", notice: { text: "Kimi Code is for coding-agent compatible flows. For generic OpenAI-compatible Kimi API keys, use Kimi API below.", apiKeyUrl: "https://platform.kimi.com/console/api-keys" }, serviceKinds: ["llm"] },
