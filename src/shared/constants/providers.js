...
export const APIKEY_PROVIDERS = {
  ...
  kimi: { id: "kimi", alias: "kimi", name: "Kimi Code", icon: "psychology", color: "#1E3A8A", textIcon: "KM", website: "https://www.kimi.com/code", notice: { text: "Kimi Code API key. OpenAI-compatible endpoint; Kimi API keys can use Kimi API below.", apiKeyUrl: "https://platform.kimi.com/console/api-keys" }, serviceKinds: ["llm", "webSearch"], searchViaChat: { defaultModel: "kimi-for-coding", pricingUrl: "https://platform.kimi.com/docs/pricing/chat" } },
  "kimi-api": { id: "kimi-api", alias: "moonshot", name: "Kimi API", icon: "psychology", color: "#0F766E", textIcon: "KA", website: "https://platform.kimi.com", notice: { text: "Moonshot/Kimi platform API key. Supports api.moonshot.ai and api.moonshot.cn.", apiKeyUrl: "https://platform.kimi.com/console/api-keys" }, serviceKinds: ["llm", "webSearch"], searchViaChat: { defaultModel: "kimi-k2.6", pricingUrl: "https://platform.kimi.com/docs/pricing/chat" } },
