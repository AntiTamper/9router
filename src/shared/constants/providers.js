...
export const APIKEY_PROVIDERS = {
  ...
  kimi: { id: "kimi", alias: "kimi", name: "Kimi Code", icon: "psychology", color: "#1E3A8A", textIcon: "KM", website: "https://www.kimi.com/code", notice: { apiKeyUrl: "https://platform.kimi.com/console/api-keys" }, serviceKinds: ["llm", "webSearch"], searchViaChat: { defaultModel: "kimi-for-coding", pricingUrl: "https://platform.kimi.com/docs/pricing/chat" } },
