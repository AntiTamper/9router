 ...
 *
 * Reuses the shared thinking parser so Claude/OpenAI/Responses/Gemini/Qwen
 * shapes map consistently. Explicit none/off/disabled returns null. Synthetic
 * `-thinking` model aliases keep the default budget.
 *
